...
namespace LoginMicrosoft.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(
            ...
            UserManager<IdentityUser> userManager, IAccountRepo Iaccount)
        {
        ...
        string? remoteError = null)
        {
            ...
            //Adding the user to Users Table in myDB
            User NewUser = UserExternalIdentityMapper.ExternalUserToUser(usuario);
            IAccount.AddInUsers(NewUser);
            Customer NewCustomer = UserExternalIdentityMapper.IdentityUserToCustomer(NewUser);
